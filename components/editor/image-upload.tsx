...
export function ImageUpload({ onImageChange, initialImage = null }: ImageUploadProps) {
          ...
          {isUploading ? (
            <div className="space-y-4">
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
                <div className="bg-theme-purple-600 h-2.5 rounded-full" style={{ width: `${uploadProgress}%` }}></div>
              </div>
            </div>
          ) : (
            <>
